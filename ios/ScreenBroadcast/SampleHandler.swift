...
let broadcastLogger = OSLog(subsystem: "com.vanshtalwar.screenshare", category: "Broadcast")
private enum Constants {
    // the App Group ID value that the app and the broadcast extension targets are setup with. It differs for each app.
    static let appGroupIdentifier = "group.com.vanshtalwar.screenshare.ScreenBroadcast"
}
